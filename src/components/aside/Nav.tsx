                                        ...
                                        options.map(({ id, text, icon, href }) => {
                                            const Icon = icon;
                                                ...
                                                return (
                                                    <li key={id}>
                                                        <Link href={href}>
                                                            <a className={classNames('flex items-center gap-x-2 p-2 text-base text-white-50 rounded transition-colors hover:bg-black-700', { 'bg-black-700': router.pathname === `${href}`})}>
